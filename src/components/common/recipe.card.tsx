  ...
  const handleDelete = () => {
    startTransition(async () => {
      try {
        ...
        console.error("Помилка під час видалення рецепта:", error);
      }
    });
  };
  ...
  return (
    <Card className="w-full min-w-[254px] max-w-md h-[480px] flex flex-col">
      <div className="h-48 overflow-hidden">
        {recipe.imageUrl ? (
          <div className="relative h-48 w-full group overflow-hidden rounded-lg border border-gray-200 bg-white shadow-md transition-all hover:shadow-lg">
            <Image
              src={recipe.imageUrl}
